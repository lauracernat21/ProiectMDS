...
public class EnemyController : MonoBehaviour {
    ...
    void Start () {
        ...
        attack_Timer = wait_Before_Attack;       //cand enemyul ajunge prima data la player ataca imediat

        current_Chase_Distance = chase_Distance;  //memoreaza valoarea chase distance
    ...
    void Chase() {
        ...
        } else if(Vector3.Distance(transform.position, target.position) > chase_Distance) //verific daca pot sa il atac
            {
